	...
	<form class="row g-3" action="Inscription" method="post">
		<div class="row g-3">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<label for="validationDefault01" class="form-label">Pseudo</label> <input
					type="text" name="pseudo" class="form-control"
					value="${param.pseudo}" id="validationDefault01" required>
			</div>
		</div>
		<div class="row g-3">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<label for="validationDefault01" class="form-label">Prenom</label> <input
		...
		<div class="row g-3">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<label for="exampleInputPassword1" class="form-label">Mot de
					passe</label> <input type="password" class="form-control" name="motDePasse"
