    ...
    <form action="ModifierProfil" method="POST" class="row g-3">
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="motDePasseActuel" name="motDePasseActuel">
            </div>
            <div class="mb-3">
     ...
     <div class="mb-3">
                <label for="confirmationMotDePasse" class="form-label">Confirmez le nouveau mot de passe :</label>
