...
public class ArticleVenduManagerImpl implements ArticleVenduManager {
	...
	public ArticleVendu add(Integer noArticle, String nomArticle, String description, LocalDateTime dateDebutEncheres,
			LocalDateTime dateFinEncheres, Integer prixInitial, Integer prixVente, String etatVente)
			throws DatabaseException {
		final ArticleVendu articleVendu = new ArticleVendu.Builder(noArticle, nomArticle, description,
				dateDebutEncheres, dateFinEncheres, prixInitial, prixVente, etatVente).build();
